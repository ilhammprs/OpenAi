...
import { ChatStore } from "../store/StoreChat";
...
import AnimateChats from "../components/Animasi";
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex flex-col leading-tight">
                  <div className="mt-1 flex items-center">
                    <span className="text-gray-700 mr-3">Chat OpenAI</span>
                  </div>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                      <div className="flex min-h-full items-center justify-center p-4 text-center">
                        <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                          ...
                          Apakah Anda yakin menghapus semua obrolan?
                          </Dialog.Description>
              ...
              {chats?.length === 0 && (
                ...
                >
                  <div className="text-center text-gray-600">
                    <p>Tidak ada pesan di sini...</p>
                    <p>Kirim pesan atau ketuk ikon salam di bawah</p>
                    <div className="cursor-pointer">
                      <button
                        type="button"
                        className="my-10"
                        onClick={() => addChat("Hallo, apa kabar?")}
                      >
                          ...
                          <div className="fixed inset-0 overflow-y-auto">
                            <div className="flex min-h-full items-center justify-center p-4 text-center">
                              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                ...
                                <Dialog.Description className="mt-1">
                                 Apakah Anda yakin menghapus obrolan {item.chat} ?
                                </Dialog.Description>
                                <div className="mt-4 flex justify-end space-x-4">
                                  <button
                                    type="button"
